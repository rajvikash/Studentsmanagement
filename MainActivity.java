...
import com.example.vikashkumar.studentmanagement.R;
...
class Student{
    ...
    Student(String name, int num,String address,String collegeName){
        this.name = name;
        this.num = num;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentNameTF = findViewById(R.id.edit_txt1);
        studentPhoneTF = findViewById(R.id.edit_txt2);
        studentAddressTF = findViewById(R.id.edit_txt3);
        addStudentBtn = findViewById(R.id.add);
        displayStudentBtn = findViewById(R.id.display);

        //displayStudentsResultTV = findViewById(R.id.display_student_details_text_view);

        spinnerCollegeNames = findViewById(R.id.edit_txt4);
        ...
        addStudentBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                studentArrayList.add(new Student(name, phone, address, collegeName));
        ...
        displayStudentBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i=0; i<studentArrayList.size(); i++) {
                    ...
                    displayStudentsResultTV.setText(displayStudentsResultTV.getText() +
                            "Student College is: " + studentArrayList.get(i).collegeName + "\n");
                    displayStudentsResultTV.setText(displayStudentsResultTV.getText() +
                            "Student Phone Number is: " + studentArrayList.get(i).num + "\n");
                    displayStudentsResultTV.setText(displayStudentsResultTV.getText() +
